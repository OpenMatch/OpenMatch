...
def main():
    ...
    if data_args.train_n_passages != 1:
        logger.warning(
            "train_n_passages is not 1, but %d, setting to 1", data_args.train_n_passages
        )
    ...
    train_dataset_cls = (
        MappingDRPretrainDataset if training_args.use_mapping_dataset else StreamDRPretrainDataset
    )
